  ...
  describe 'When a user visits /comedians' do
    ...
    before(:each) do
      @comedian_1 = Comedian.create(
        name:"Lewis Black", age:80,
        city: "New York, New York", image_url:"https://www.datocms-assets.com/4857/1522135089-493595692_1280x720.jpg")
      @special_1a = @comedian_1.specials.create(
        name:"Lewis Black: Stark Raving Black", length:50,
      ...
      @special_1b = @comedian_1.specials.create(
        name:"Lewis Black: In God We Rust", length:60,
      ...
      @special_1c = @comedian_1.specials.create(
        name:"Lewis Black: Black to the Future", length:70,
      ...
      @special_8a = @comedian_8.specials.create(
        name:'Iliza: Elder Millennial', length:20,
      ...
      @special_8b = @comedian_8.specials.create(
        name:'Iliza Shlesinger: Confirmed Kills', length:30,
      ...
      @special_8c = @comedian_8.specials.create(
        name:'Iliza Shlesinger: Freezing Hot', length:40,
    ...
    it 'Should see statistics for the displayed comedians' do
      visit '/comedians'

      within('.statistics') do
        expect(page).to have_content('60.0 years')
        expect(page).to have_content('45.0 min')
        expect(page).to have_content('6 specials')
    ...
    describe 'When a user queries by age ex: /comedians?age=34 ' do
      describe 'They should see the comedian index with' do
        ...
        it 'Should see statistics for the filtered comedians' do
          visit '/comedians?age=40'

          within('.statistics') do
            expect(page).to have_content('40.0 years')
            expect(page).to have_content('30.0 min')
